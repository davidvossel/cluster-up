...
master_ip=$(_main_ip)
kubeconfig=${BASE_PATH}/cluster-providers/$KUBEVIRT_PROVIDER/.kubeconfig
kubectl=${BASE_PATH}/cluster-providers/$KUBEVIRT_PROVIDER/.kubectl
...
function _kubectl() {
    ...
    ${KUBEVIRT_PATH}cluster-providers/$KUBEVIRT_PROVIDER/.kubectl "$@"
}
